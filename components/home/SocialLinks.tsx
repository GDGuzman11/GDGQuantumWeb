 ...
 *
 * The hrefs come from lib/profile (socialUrls) so the footer links and the
 * JSON-LD `sameAs` always point at the same profiles.
 */
import { socialUrls } from '@/lib/profile';
