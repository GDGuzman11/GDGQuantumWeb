...
exports.UNLOCK_GATE_LEVEL = exports.RECRUIT_WEAPONS = exports.DEFAULT_THROWABLE = exports.DEFAULT_LOADOUT = exports.THROWABLES = exports.SIDEARMS = exports.SECONDARIES = exports.PRIMARIES = exports.GUNS = void 0;
exports.gunById = gunById;
exports.throwById = throwById;
exports.GUNS = [
...
function gunById(id) {
    return exports.GUNS.find((g) => g.id === id) ?? exports.GUNS[0];
}
...
const PRIMARY_FAMILIES = ['rifle', 'mg', 'laser'];
const SECONDARY_FAMILIES = ['sniper', 'launcher'];
exports.PRIMARIES = exports.GUNS.filter((g) => PRIMARY_FAMILIES.includes(g.family));
exports.SECONDARIES = exports.GUNS.filter((g) => SECONDARY_FAMILIES.includes(g.family));
exports.SIDEARMS = exports.GUNS.filter((g) => g.family === 'pistol');
exports.THROWABLES = [
...
function throwById(id) {
    return exports.THROWABLES.find((t) => t.id === id) ?? exports.THROWABLES[0];
}
/** Default loadout (used if you skip the loadout screen) — the Standard Issue recruit kit. */
exports.DEFAULT_LOADOUT = ['ar01', 'rt06', 'sp01'];
exports.DEFAULT_THROWABLE = 'frag';
...
exports.RECRUIT_WEAPONS = new Set(['ar01', 'cb02', 'vx04', 'er08', 'rt06', 'gc03', 'pm09', 'rc12', 'sp01', 'mp05']);
/** Campaign level a player must have reached before locked guns can be purchased. */
exports.UNLOCK_GATE_LEVEL = 5;
